...
namespace StandaloneRepo.Migrations
{
    ...
    [Migration("20240419210354_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StandaloneRepo.ServiceModel.Users.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("GoogleProfilePageUrl")
                        .HasColumnType("text")
                        .HasColumnName("google_profile_page_url");
                    ...
                    b.ToTable("application_user", "public");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StandaloneRepo.ServiceModel.Users.ApplicationUser", null)
                        .WithMany()
